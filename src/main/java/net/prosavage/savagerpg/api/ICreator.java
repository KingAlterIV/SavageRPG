...
public class ICreator {
    ...
    public String getPersistentEntityTypeInput() {
        return this.player.getPersistentDataContainer().getOrDefault(INamespacedKeys.CREATOR_ENTITY_TYPE,
                PersistentDataType.STRING, "null");
    }

    public String getPersistentEntityRegionInput() {
        return this.player.getPersistentDataContainer().getOrDefault(INamespacedKeys.CREATOR_ENTITY_REGION,
                PersistentDataType.STRING, "null");
    }

    public String getPersistentEntityNameInput() {
        return this.player.getPersistentDataContainer().getOrDefault(INamespacedKeys.CREATOR_ENTITY_NAME,
                PersistentDataType.STRING, "null");
    }

    public double getPersistentEntityHealthInput() {
        return this.player.getPersistentDataContainer().getOrDefault(INamespacedKeys.CREATOR_ENTITY_HEALTH,
                PersistentDataType.DOUBLE, 0.0);
    }

    public int getPersistentEntityLevelInput() {
        return this.player.getPersistentDataContainer().getOrDefault(INamespacedKeys.CREATOR_ENTITY_LEVEL,
                PersistentDataType.INTEGER, 0);
    }

    public double getPersistentEntityMinimumEXPInput() {
        return this.player.getPersistentDataContainer().getOrDefault(INamespacedKeys.CREATOR_ENTITY_MINIMUM_EXP,
                PersistentDataType.DOUBLE, 0.0);
    }

    public double getPersistentEntityMaximumEXPInput() {
        return this.player.getPersistentDataContainer().getOrDefault(INamespacedKeys.CREATOR_ENTITY_MAXIMUM_EXP,
                PersistentDataType.DOUBLE, 0.0);
    }

    public double getPersistentEntityMinimumDamageInput() {
        return this.player.getPersistentDataContainer().getOrDefault(INamespacedKeys.CREATOR_ENTITY_MINIMUM_DAMAGE,
                PersistentDataType.DOUBLE, 0.0);
    }

    public double getPersistentEntityMaximumDamageInput() {
        return this.player.getPersistentDataContainer().getOrDefault(INamespacedKeys.CREATOR_ENTITY_MAXIMUM_DAMAGE,
                PersistentDataType.DOUBLE, 0.0);
    }

    public double getPersistentEntityMinimumProtectionInput() {
        return this.player.getPersistentDataContainer().getOrDefault(INamespacedKeys.CREATOR_ENTITY_MINIMUM_PROTECTION,
                PersistentDataType.DOUBLE, 0.0);
    }

    public double getPersistentEntityMaximumProtectionInput() {
        return this.player.getPersistentDataContainer().getOrDefault(INamespacedKeys.CREATOR_ENTITY_MAXIMUM_PROTECTION,
                PersistentDataType.DOUBLE, 0.0);
    }

    public String getPersistentEntityHeldItemInput() {
        return this.player.getPersistentDataContainer().getOrDefault(INamespacedKeys.CREATOR_ENTITY_HELD_ITEM,
                PersistentDataType.STRING, "AIR");
    }

    public String getPersistentEntityHelmetInput() {
        return this.player.getPersistentDataContainer().getOrDefault(INamespacedKeys.CREATOR_ENTITY_HELMET,
                PersistentDataType.STRING, "AIR");
    }

    public String getPersistentEntityChestplateInput() {
        return this.player.getPersistentDataContainer().getOrDefault(INamespacedKeys.CREATOR_ENTITY_CHESTPLATE,
                PersistentDataType.STRING, "AIR");
    }

    public String getPersistentEntityLeggingsInput(){
        return this.player.getPersistentDataContainer().getOrDefault(INamespacedKeys.CREATOR_ENTITY_LEGGINGS,
                PersistentDataType.STRING, "AIR");
    }

    public String getPersistentEntityBootsInput(){
        return this.player.getPersistentDataContainer().getOrDefault(INamespacedKeys.CREATOR_ENTITY_BOOTS,
                PersistentDataType.STRING, "AIR");
    }

    public byte getPersistentEntitySpawnInput(){
        return this.player.getPersistentDataContainer().getOrDefault(INamespacedKeys.CREATOR_ENTITY_SPAWN_ENTITY,
                PersistentDataType.BYTE, (byte) 0);
    }
}
