...
>>>>>>> 9bc3217... Finished armor creation and cleaned up more things
    ...
    public int getLevel(ItemStack itemStack) {
        ...
        ItemMeta meta = itemStack.getItemMeta();
        PersistentDataContainer persistentDataContainer = meta.getPersistentDataContainer();
        return persistentDataContainer.getOrDefault(INamespacedKeys.WEAPON_LEVEL, PersistentDataType.INTEGER, 0);
    }
...
>>>>>>> 71fac37... Renamed things back, new & better files manager, more stuff fixed.:src/main/java/net/prosavage/savagerpg/api/itemstacks/IWeapon.java
    ...
    public int getGems(ItemStack itemStack) {
        ...
        ItemMeta meta = itemStack.getItemMeta();
        PersistentDataContainer persistentDataContainer = meta.getPersistentDataContainer();
        return persistentDataContainer.getOrDefault(INamespacedKeys.WEAPON_GEM, PersistentDataType.INTEGER, 0);
    }
    ...
    public int getScrolls(ItemStack itemStack) {
        ...
        ItemMeta meta = itemStack.getItemMeta();
        PersistentDataContainer persistentDataContainer = meta.getPersistentDataContainer();
        return persistentDataContainer.getOrDefault(INamespacedKeys.WEAPON_SCROLL, PersistentDataType.INTEGER, 0);
    }
