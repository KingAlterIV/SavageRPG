...
public class ArmorFiles {
    ...
    public ArmorFiles(String rarity, String name){
        this.rarity = rarity;
        this.name = name;
        this.rarityFolders = new File(SavageRPG.getInstance().getArmorFolder()).listFiles();
        this.armorFile = new File(SavageRPG.getInstance().getArmorFolder() + File.separator + this.rarity + File.separator + this.name + ".yml");
    ...
    public ArmorFiles setName(String name) {
        String path = SavageRPG.getInstance().getArmorFolder() + File.separator + this.rarity + File.separator + name + ".yml";
    ...
    public ArmorFiles setRarity(String rarity) {
        String path = SavageRPG.getInstance().getArmorFolder() + File.separator + rarity + File.separator + this.name + ".yml";
        File oldFolderFile = new File(SavageRPG.getInstance().getArmorFolder() + File.separator + this.rarity);
        File newFolderFile = new File(SavageRPG.getInstance().getArmorFolder() + File.separator + rarity);
