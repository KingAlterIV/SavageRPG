package net.prosavage.savagerpg.builders.miscellaneous;

import net.prosavage.savagerpg.utils.Config;
...
public class Ability {
    ...
    public Ability build(){
        File file = new File(net.prosavage.savagerpg.SavageRPG.getInstance().getDataFolder(), "abilities\\" + name + ".yml");
        if (!(file.exists())){
            Config config = new Config(net.prosavage.savagerpg.SavageRPG.getInstance(), "abilities\\" + name + ".yml");
        ...
        if (this.hasLeftAction){
            net.prosavage.savagerpg.SavageRPG.getInstance().getLeftClickInteractions().put(name, leftAction);
        }
        if (this.hasRightAction){
            net.prosavage.savagerpg.SavageRPG.getInstance().getRightClickInteractions().put(name, rightAction);
        }
        if (this.hasDropAction){
            net.prosavage.savagerpg.SavageRPG.getInstance().getItemDropInteractions().put(name, dropAction);
        }
        return this;
    }
