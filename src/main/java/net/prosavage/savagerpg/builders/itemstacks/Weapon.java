package net.prosavage.savagerpg.builders.itemstacks;
...
>>>>>>> 2a3b3d0... Removed unused weapon imports, Cleaned up weapons and some warnings (IntelliJ)
    ...
    public ItemStack build() {
        ...
        if (meta != null) {
            ...
            List<String> itemLore = net.prosavage.savagerpg.SavageRPG.getInstance().getConfig().getStringList("weapon.lore");
