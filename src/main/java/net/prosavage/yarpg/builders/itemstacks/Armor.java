...
public class Armor {
    ...
    public ItemStack build() {
        ...
        if (meta != null) {
            ...
            List<String> itemLore = net.prosavage.yarpg.YaRPG.getInstance().getConfig().getStringList("armor.lore");
    ...
    public void setPersistentDataContainers(){
        ...
        persistentDataContainer.set(YNamespacedKeys.ARMOR_NAME, PersistentDataType.STRING, this.name);
        persistentDataContainer.set(YNamespacedKeys.ARMOR_MATERIAL, PersistentDataType.STRING, this.material);
        persistentDataContainer.set(YNamespacedKeys.ARMOR_RARITY, PersistentDataType.STRING, this.rarity);
        persistentDataContainer.set(YNamespacedKeys.ARMOR_CHANCE, PersistentDataType.DOUBLE, this.chance);
        if (backgroundLore != null && (!backgroundLore.equals("null"))) {
            persistentDataContainer.set(YNamespacedKeys.ARMOR_BACKGROUND_LORE, PersistentDataType.STRING, backgroundLore);
        }
        persistentDataContainer.set(YNamespacedKeys.ARMOR_LEVEL, PersistentDataType.INTEGER, this.level);
        persistentDataContainer.set(YNamespacedKeys.ARMOR_MINIMUM_PROTECTION, PersistentDataType.DOUBLE, this.minimumProtection);
        persistentDataContainer.set(YNamespacedKeys.ARMOR_MAXIMUM_PROTECTION, PersistentDataType.DOUBLE, this.maximumProtection);
        persistentDataContainer.set(YNamespacedKeys.ARMOR_PROTECTION, PersistentDataType.DOUBLE, this.protection);
        persistentDataContainer.set(YNamespacedKeys.ARMOR_MINIMUM_HEALTH, PersistentDataType.DOUBLE, this.minimumHealth);
        persistentDataContainer.set(YNamespacedKeys.ARMOR_MAXIMUM_HEALTH, PersistentDataType.DOUBLE, this.maximumHealth);
        persistentDataContainer.set(YNamespacedKeys.ARMOR_HEALTH, PersistentDataType.DOUBLE, this.health);
        persistentDataContainer.set(YNamespacedKeys.ARMOR_MINIMUM_REGEN, PersistentDataType.DOUBLE, this.minimumRegen);
        persistentDataContainer.set(YNamespacedKeys.ARMOR_MAXIMUM_REGEN, PersistentDataType.DOUBLE, this.maximumRegen);
        persistentDataContainer.set(YNamespacedKeys.ARMOR_REGEN, PersistentDataType.DOUBLE, this.regen);
        persistentDataContainer.set(YNamespacedKeys.ARMOR_GEM, PersistentDataType.INTEGER, this.gems);
        persistentDataContainer.set(YNamespacedKeys.ARMOR_SCROLL, PersistentDataType.INTEGER, this.scrolls);
        persistentDataContainer.set(YNamespacedKeys.ARMOR_IS_SPAWNED_IN, PersistentDataType.BYTE, this.spawnedIn);
        if (this.itemCreator != null) {
            persistentDataContainer.set(YNamespacedKeys.CREATOR_ARMOR_PLAYER, PersistentDataType.STRING, this.itemCreator);
        }
    }
